...
if (GetLocale() == "enUS") then
	ACP:UpdateLocale(

		{
			...
			["Use for Raid/Dungeons"] = "Use for Raid/Dungeons",
			["Use for Open World"] = "Use for Open World",
			["Addons [%s] updated for use in Open World."] = "Addons [%s] updated for use in Open World.",
			["Addons [%s] updated for use in Raid/Dungeons."] = "Addons [%s] updated for use in Raid/Dungeons.",
			["Set [%s] already in use by Open World."] = "Set [%s] already in use by Open World.",
			["Set [%s] already in use by Raid/Dungeons."] = "Set [%s] already in use by Raid/Dungeons.",
			["Zone type change detected. Load set [%s] for [%s]?"] = "Zone type change detected. Load set [%s] for [%s]?",
			["Raid/Dungeons"] = "Raid/Dungeons",
			...
			Recursive = "Recursive",
			AutoLoad = "Auto Load profiles",
			["Recursive Enable is now %s"] = "Recursive Enable is now %s",
			["Auto Load Profiles is now %s"] = "Auto Load Profiles is now %s",
			Reload = "Reload",
			ReloadUI = "ReloadUI",
			...
			["AutoLoadProfiles-ToolTip"] = "When enabled, will ask for load profile set to the current zone.",
			Save = "Save",
